...
<html>
    <head>
        <meta charset="UTF-8">
        <title>AdminLTE | Data Tablesexperimenticheck</title>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 col-sm-8">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table id="example2" class="table table-mailbox table-bordered table-hover ">
                                                	<thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        <tr class="unread">
                                                            ...
                                                            <td class="time">January 8, 2013 3:49</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="small-col"><input type="checkbox" /></td>
                                                            ...
                                                            <td class="subject"><a href="#">Urgent! Please read</a></td>
                                                            <td class="time">January 8, 2013 3:51</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="small-col"><input type="checkbox" /></td>
                                                            <td class="small-col"><i class="fa fa-star-o"></i></td>
