...
if(isset($_POST['btnEditUser'])){
    $_SESSION['userIDEdit'] = $_POST['userIDEdit'];
    header("location: ./editusers");
}
if(isset($_POST['btnRegisterUser'])){
    header("location: ./registerusers");
}
?>
<!DOCTYPE html>
<html>
                                ...
                                <table class="table text-center">
                                    <tr>
                                        <td>
                                            <?php
                                            echo "<form action=\"./\" method=\"post\">";
                                                echo "<input type=\"submit\" name=\"btnRegisterUser\" value=\"Register User\" class=\"btn btn-default btn-flat\">";
                                            echo "</form>";
                                            ?>
                                        </td>
                                    </tr>
                                ...
                                if (mysql_num_rows($SQLQuery) > 0) {
                                    while ($row = mysql_fetch_array($SQLQuery)) {
                                        echo "<tr>";
                                            ...
                                            echo "<td>";
                                                echo "<form action=\"./\" method=\"post\">";
                                                    $userIDEdit = $row['userID'];
                                                    echo "<input type=\"hidden\" name=\"userIDEdit\" value=\"$userIDEdit\">";
                                                    echo "<input type=\"submit\" name=\"btnEditUser\" value=\"Edit\" class=\"btn btn-default btn-flat\">";
                                                echo "</form>";
                                            echo "</td>";
                                        echo "</tr>";
                                    }
