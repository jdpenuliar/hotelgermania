        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li id="commentsTab" class="active">
                    <a href="./" onclick="process(0,'comments');">
                    ...
                    <div class="box">
                        ...
                        <div id="mainContent" class="box-body table-responsive">
                            <table id="example1" class="table table-bordered table-hover table-striped table-mailbox">
                                ...
                                $SQLQuery = mysql_query("SELECT * FROM tblcomments") or die(mysql_error());
                                if (mysql_num_rows($SQLQuery) > 0) {
                                    while ($row = mysql_fetch_array($SQLQuery)) {
                                        echo "<tr>";
                                            ...
                                            echo "</td>";
                                            echo "<td>";
                                                echo $row['commenterEmail'];
                                            echo "</td>";
                                            echo "<td>";
                                                echo $row['commenterPhoneNumber'];
                                            echo "</td>";
                                            echo "<td>";
                                                echo $row['comment'];
                                            echo "</td>";
